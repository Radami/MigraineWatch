...
class MockDataInterceptor : Interceptor {
    ...
    private fun generateMockJson(): String {
        ...
        for (i in -720..168) {
            ...
            // i=0 is 'now'
            // Event 1: 10hPa drop starting at i=3 (3 hours from now) over 24h
            // Event 2: 12hPa rise starting immediately after Event 1 at i=27 over 24h
